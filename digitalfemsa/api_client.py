...
from digitalfemsa.api_response import ApiResponse, T as ApiResponseT
import digitalfemsa.models
from digitalfemsa import rest
from digitalfemsa.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'App/v2 PythonBindings/1.2.0'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(digitalfemsa.models, klass)
