...
class CheckoutRequest(BaseModel):
    ...
    redirection_time: Optional[StrictInt] = Field(default=None, description="Number of seconds to wait before redirecting to the success or failure url")
    __properties: ClassVar[List[str]] = ["allowed_payment_methods", "expires_at", "failure_url", "name", "on_demand_enabled", "success_url", "type", "redirection_time"]
